...
<head>
    ...
    <link rel="stylesheet" href="{{asset('back/')}}/assets/vendor/datepicker/tempusdominus-bootstrap-4.css" />
    <link rel="stylesheet" href="{{asset('back/')}}/assets/vendor/inputmask/css/inputmask.css" />
</head>
